...
#     Create a test directory structure under the given base path.

#     Layout:
#         t_symlink/
#             t1/
#                 t4/
#                     ola -> symlink pointing to t_symlink/t2/ola
#             t2/
#                 ola    # file containing "lorem ipsum dolor sit"
#             t3/

#     Args:
#         t_symlink (pathlib.Path): Base directory under which the structure is created.
...
if __name__ == "__main__":
    ...
    if pid == 0:
        ...
        assert(res == 0)
        res = mn_sbx.mini_sandbox_mount_overlay(str(dir_path/"t1"/"t4"))
